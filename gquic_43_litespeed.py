...
from FullCHLOPacket_litespeed import FullCHLOPacket
...
from QUIC_43_litespeed import QUICHeader
...
class Scapy:
    ...
    def send_chlo(self, only_reset):
        ...
        print('CID', string_to_ascii(SessionInstance.get_instance().connection_id))
